...
func (m *MockGateway) ChainGetTipSetAfterHeight(ctx context.Context, h abi.ChainEpoch, tsk types.TipSetKey) (*types.TipSet, error) {
	//TODO implement me
	panic("implement me")
}
...
func (m *MockGateway) MsigGetVestingSchedule(ctx context.Context, addr address.Address, tsk types.TipSetKey) (api.MsigVesting, error) {
	//TODO implement me
	panic("implement me")
}

func (m *MockGateway) StateReadState(ctx context.Context, actor address.Address, tsk types.TipSetKey) (*api.ActorState, error) {
	//TODO implement me
	panic("implement me")
}

func (m *MockGateway) StateSearchMsg(ctx context.Context, from types.TipSetKey, msg cid.Cid, limit abi.ChainEpoch, allowReplaced bool) (*api.MsgLookup, error) {
	//TODO implement me
	panic("implement me")
}

func (m *MockGateway) StateWaitMsg(ctx context.Context, cid cid.Cid, confidence uint64, limit abi.ChainEpoch, allowReplaced bool) (*api.MsgLookup, error) {
	//TODO implement me
	panic("implement me")
}
